...
import LayoutNoContent from '../components/common/Layout/LayoutNoContent';

function login(props) {
  return (
    <LayoutNoContent title="Sign In" icon="/favicons/signin.svg">
      <div className="p-3 min-h-screen flex items-center justify-center">
        <div className="flex flex-col w-full max-w-md px-4 py-8 bg-white rounded-lg shadow-post dark:bg-gray-800 sm:px-6 md:px-8 lg:px-10">
          <div className="mb-5 mx-auto">
            <Link href="/">
              <a className="text-3xl font-bold text-white bg-black px-5 py-2 rounded-lg">
                BWhite.
              </a>
            </Link>
          </div>
